...
// Command     : write_verilog D:/Kareem_Wassem/DESIGN/Projects/SPI_Slave_With_Single_Port_RAM/PSEQENTIAL_NETLIST.v
// Design      : SPI
...
module SPI
  ...
  RAM RAM1
       (.CLK_IBUF_BUFG(CLK_IBUF_BUFG),
        ...
        .rx_valid(rx_valid),
        .rx_valid_reg(Slave_handler_n_17),
        .rx_valid_reg_0(Slave_handler_n_15),
        .rx_valid_reg_1(Slave_handler_n_16),
        .tx_valid(tx_valid));
  IBUF SS_n_IBUF_inst
       (.I(SS_n),
        .O(SS_n_IBUF));
...
module SPI_Slave
  ...
  LUT6 #(
    .INIT(64'h000000000000F04F)) 
    \FSM_sequential_cs[0]_i_1 
       (.I0(is_address_received_reg_n_0),
        .I1(MOSI_IBUF),
        .I2(cs[0]),
        .I3(cs[1]),
        .I4(cs[2]),
  ...
  LUT6 #(
    ...
    is_address_received_i_2
       (.I0(rst_n_IBUF),
        ...
        .I5(is_address_received_i_3_n_0),
