...
// Command     : write_verilog D:/Kareem_Wassem/DESIGN/Projects/SPI_Slave_With_Single_Port_RAM/ONE_HOT_NETLIST.v
// Design      : SPI
...
module SPI
  ...
  RAM RAM1
       (.CLK_IBUF_BUFG(CLK_IBUF_BUFG),
        ...
        .flag_write00_out(flag_write00_out),
        .flag_write_reg_0(RAM1_n_7),
        .rst_n_IBUF(rst_n_IBUF),
        .\rx_data_reg[8] (Slave_handler_n_12),
        .\rx_data_reg[8]_0 (Slave_handler_n_15),
        .\rx_data_reg[9] (Slave_handler_n_17),
        .\rx_data_reg[9]_0 (Slave_handler_n_16),
        .\rx_data_reg[9]_1 (Slave_handler_n_14),
        .tx_valid(tx_valid));
  IBUF SS_n_IBUF_inst
       (.I(SS_n),
        .O(SS_n_IBUF));
...
module SPI_Slave
  ...
  wire \Parallel_data_out[7]_i_4_n_0 ;
  ...
  LUT5 #(
    ...
    \FSM_onehot_cs[4]_i_2 
       (.I0(SS_n_IBUF),
        .I1(is_address_received_reg_n_0),
        .I2(MOSI_IBUF),
  ...
  LUT6 #(
    ...
    MISO_i_1
       (.I0(\FSM_onehot_cs_reg_n_0_[2] ),
        ...
        .I4(cycle_counter_PAR_TO_SER_reg__0[3]),
        .I5(data_received_reg_0),
        .O(MISO_i_1_n_0));
  FDRE #(
    .INIT(1'b0)) 
    MISO_reg
  ...
  LUT5 #(
    ...
    \Parallel_data_out[7]_i_2 
       (.I0(tx_valid),
        .I1(data_received_reg_0),
        .I2(cycle_counter_PAR_TO_SER_reg__0[3]),
        .I3(\FSM_onehot_cs_reg_n_0_[4] ),
        .I4(\Parallel_data_out[7]_i_4_n_0 ),
  ...
  LUT3 #(
    .INIT(8'hFE)) 
    \Parallel_data_out[7]_i_4 
       (.I0(\FSM_onehot_cs_reg_n_0_[3] ),
        .I1(\FSM_onehot_cs_reg_n_0_[1] ),
        .I2(\FSM_onehot_cs_reg_n_0_[2] ),
        .O(\Parallel_data_out[7]_i_4_n_0 ));
  FDRE #(
    .INIT(1'b0)) 
  ...
  FDRE #(
    ...
    \cycle_counter_SER_TO_PAR_reg[3] 
       (.C(CLK),
        ...
        .R(\Parallel_data_out[7]_i_1_n_0 ));
  LUT6 #(
    .INIT(64'h00FFCFFFAA002000)) 
    data_received_i_1
       (.I0(tx_valid),
        .I1(SS_n_IBUF),
        .I2(data_received_i_2_n_0),
        .I3(rst_n_IBUF),
        .I4(data_received_i_3_n_0),
        .I5(data_received_reg_0),
  ...
  LUT5 #(
    ...
    data_received_i_3
       (.I0(MISO_i_1_n_0),
        .I1(cycle_counter_PAR_TO_SER_reg__0[2]),
        .I2(cycle_counter_PAR_TO_SER_reg__0[0]),
        .I3(cycle_counter_PAR_TO_SER_reg__0[1]),
        .I4(SS_n_IBUF),
  ...
  LUT4 #(
    ...
    flag_write_i_1
       (.I0(rx_data[9]),
        ...
        .O(flag_write_reg));
  LUT6 #(
    .INIT(64'h22002F0022002000)) 
    is_address_received_i_1
       (.I0(\FSM_onehot_cs_reg_n_0_[3] ),
        .I1(is_address_received_i_2_n_0),
        .I2(is_address_received_i_3_n_0),
        .I3(rst_n_IBUF),
        .I4(data_received_i_3_n_0),
  ...
  FDRE #(
    ...
    \rx_data_reg[9] 
       (.C(CLK),
        ...
        .R(SR));
  LUT6 #(
    .INIT(64'h0000F7F7000000F4)) 
    rx_valid_i_1
       (.I0(tx_valid),
        .I1(rx_valid_i_2_n_0),
        .I2(\Parallel_data_out[7]_i_4_n_0 ),
        .I3(rx_valid_i_3_n_0),
        .I4(\Parallel_data_out[7]_i_1_n_0 ),
        .I5(rx_valid),
        .O(rx_valid_i_1_n_0));
  LUT2 #(
    .INIT(4'h2)) 
